...
app.controller('mainCtrl', function($scope, itunesService){
  ...
  $scope.options = [{raw: "trackCensoredName", pretty: "Song"},{raw: "collectionName", pretty: "Album"}, {raw: "kind", pretty: "Movie"}];
...
// console.log($scope.artist); NOT WORKING
